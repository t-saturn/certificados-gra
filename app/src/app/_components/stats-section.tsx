...
import type { StatsSectionProps, StatItem } from '.';
  ...
  return (
    <div
      className="
        ...
        transition-transform duration-(--transition-slow)
        hover:scale-105
      "
    ...
    >
      ...
      <div
        className="
          absolute inset-0 m-auto h-32 w-32
          rounded-full
          bg-linear-to-br from-(--color-secondary)/20 to-transparent
          blur-2xl
        "
      />
      ...
      <div
        className="
          relative mb-2 text-5xl font-bold
          text-gradient
          sm:text-6xl
        "
      >
      ...
      <p
        className="
          relative text-base font-medium uppercase tracking-wider
...
export const StatsSection: FC<StatsSectionProps> = ({ stats }): JSX.Element => {
  return (
    ...
    >
      ...
      <div
        className="
          absolute -top-20 -left-20 h-40 w-40
          rounded-full
      ...
      <div
        className="
          absolute -bottom-20 -right-20 h-40 w-40
          rounded-full
          bg-(--color-secondary)/20
          blur-3xl
        "
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="text-lg text-(--color-text-inverse)/70">Transformando la gestión documental en Ayacucho</p>
        </div>
